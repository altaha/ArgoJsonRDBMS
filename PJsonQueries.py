...
class Query1PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("SELECT str1, num FROM nobench_main;")
...
class Query2PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("SELECT nested_obj.str1, nested_obj.num FROM nobench_main;")
...
class Query3PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("SELECT sparse_110, sparse_119 FROM nobench_main;")
...
class Query4PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("SELECT sparse_110, sparse_220 FROM nobench_main;")
...
class Query5PJson(Query):
    ...
    def prepare(self):
        ...
        results = psql_db.execute_sql("SELECT str1 FROM nobench_main")
...
class Query6PJson(Query):
    ...
    def db_command(self):
        # return psql_db.execute_sql("SELECT * FROM nobench_main WHERE num BETWEEN 30000 AND 30100;")
        return psql_db.execute_sql("SELECT * FROM nobench_main WHERE num >= {} AND num <= {};".format(self.arguments[0],
                                                                                                      self.arguments[1]))
...
class Query7PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("SELECT * FROM nobench_main WHERE dyn1 >= {} AND dyn1 <= {};".format(self.arguments[0],
                                                                                                        self.arguments[1]))
...
class Query8PJson(Query):
    ...
    def db_command(self):
        #return psql_db.execute_sql('SELECT * FROM nobench_main WHERE "{}" = ANY nested_arr;'.format(self.arguments[0]))
        cur = psql_db.cursor()
...
class Query9PJson(Query):
    ...
    def prepare(self):
        results = psql_db.execute_sql("SELECT sparse_500 FROM nobench_main")
        for index, result in enumerate(results):
    ...
    def db_command(self):
        return psql_db.execute_sql('SELECT * FROM nobench_main WHERE sparse_500 = "{}";'.format(self.arguments[0]))
...
class Query11PJson(Query):
    ...
    def db_command(self):
        return psql_db.execute_sql("""SELECT * FROM nobench_main AS left INNER JOIN
...
class Query13PJson(Query):
    ...
    def prepare(self):
        res = psql_db.execute_sql('SELECT multiply_nested_obj.level_2.level_3.level_4.level_5.level_6.level_7.level_8.deep_str_single FROM nobench_main')
        index = 5
    ...
    def db_command(self):
        return psql_db.execute_sql('SELECT * FROM  nobench_main WHERE multiply_nested_obj.level_2.level_3.level_4.level_5.level_6.level_7.level_8.deep_str_single = "{}"'.format(self.arguments[0]))
...
class Query14PJson(Query):
    ...
    def prepare(self):
        res = psql_db.execute_sql('SELECT multiply_nested_obj.level_2.level_3.level_4.level_5.level_6.level_7.level_8.deep_str_agg FROM nobench_main')
        index = 5
        for i, result in enumerate(res):
            if i == index:
    ...
    def db_command(self):
        return psql_db.execute_sql("""SELECT multiply_nested_obj.level_2.level_3.level_4.level_5.level_6.level_7.level_8.deep_str_agg
                                        FROM nobench_main
...
class InitialLoadPJson(Query):
    ...
    def db_command(self):
        ...
        pjson_load_cmd = "CREATE TABLE pjson_main(json_col jsonb);"
        pjson_load_cmd += "COPY pjson_main FROM '{0}';".format(
                PJSON_FILE_DIR + PJSON_FILENAME)
        #TODO: Add command to create table index
