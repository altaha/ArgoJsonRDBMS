        ...
        if self.predicate:
            ...
            if db.use_argo1:
                ...
                cursor.execute("CREATE TEMPORARY TABLE argo_im AS "
                                   + self.predicate.get_argo3_sql(),
                               self.predicate.params)
                #print "We are about to execute:" + self.projector.get_argo3_sql(True) + " with Params: " + str(self.projector.get_argo3_params())
            ...
            if db.use_argo1:
                ...
                #TODO this is where the printing of statements can go.
                #print "We are about to execute:" + self.projector.get_argo3_sql(False) + " with Params: " + str(self.projector.get_argo3_params())
